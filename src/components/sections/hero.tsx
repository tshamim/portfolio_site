      ...
      <div className="container py-14 sm:py-16 md:py-24">
        ...
        <div className="grid items-center gap-10 md:gap-12 md:grid-cols-[1.2fr_.8fr]">
          ...
          <div className="order-2 md:order-1 text-center md:text-left">
            <p className="badge">Product & Tech</p>
            <h1 className="mt-3 sm:mt-4 text-3xl sm:text-4xl md:text-6xl font-semibold leading-tight">
              I build <span className="name-gradient">MVPs</span> & scale{" "}
              <span className="name-gradient">web products</span> that move the business.
            </h1>

            <p className="mt-4 sm:mt-5 text-neutral-300/90 text-base sm:text-lg leading-relaxed">
              I’m <span className="font-semibold name-gradient">Shamim Ahammed</span> — Head of Technology & Product with
              12+ years in full-stack development and product leadership. If you need an MVP,
              a reliable roadmap, or a steady hand to ship, I’m your person.
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center md:justify-start gap-3">
              ...
              <a href="#projects" className="btn-ghost rounded-xl">See work</a>
            </div>
            ...
            <ul className="mt-6 sm:mt-8 grid grid-cols-2 sm:flex gap-x-6 gap-y-2 justify-center md:justify-start text-sm text-neutral-400">
              <li><span className="text-white font-semibold">12+</span> yrs</li>
              <li><span className="text-white font-semibold">20+</span> products</li>
              <li className="col-span-2 sm:col-span-1"><span className="text-white font-semibold">SaaS / E-com</span></li>
            </ul>
          </div>
        </div>
      </div>
